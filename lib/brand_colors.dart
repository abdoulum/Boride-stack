...
class BrandColors{
  ...
  static const Color colorAccent1 = Color(0xfffefff7);
  static const Color Accent2 = Color(0xffeaedf7);
  static const Color tabAccent = Color(0xffa9ddf9);


  static const Color colorBackground = Color(0xFFFBFAFF);

  static const Color colorPink = Color(0xFF777F8A);
  ...
  static const Color colorTextM = Color(0xFF646363);
