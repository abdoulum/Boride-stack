...
class _DiscountScreenState extends State<DiscountScreen> {
  ...
  checkPromo(){
    DatabaseReference promoRef = FirebaseDatabase.instance.ref().child("users").child(fAuth.currentUser!.uid).child("promo");
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Padding(
                        ...
                        child: Text(
                          "Enter promo code",
                          style: TextStyle(fontFamily: "Brand-Regular", color: BrandColors.colorTextSemiLight),
                        )),
                  ),
                ),
