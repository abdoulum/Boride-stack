                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                          padding: const EdgeInsets.all(8),
                          child: Text(
                            userFavoriteAddress.isNotEmpty
                                ? userFavoriteAddress
                                : "Favorite location",
                            style: const TextStyle(
                              fontFamily: "Brand-Regular",
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                          padding: const EdgeInsets.all(8),
                          child: Text(
                            userFavoriteAddress2.isNotEmpty
  ...
  saveFavoriteLocations() async {
    ...
    if (userHomeAddress.isNotEmpty) {
      ...
      FirebaseDatabase.instance
          ...
          .child("favorite_location")
          .child("my_home_address_id")
          .set(userHomeAddressId);
    }
    ...
    if (userFavoriteAddressId.isNotEmpty) {
      ...
      FirebaseDatabase.instance
          ...
          .child(fAuth.currentUser!.uid)
          .child("favorite_location")
          .child("my_favorite_address_id")
          .set(userFavoriteAddressId);
    }
    if (userFavoriteAddress2Id.isNotEmpty) {
      ...
      FirebaseDatabase.instance
          ...
          .child(fAuth.currentUser!.uid)
          .child("favorite_location")
          .child("my_favorite_address2_id")
          .set(userFavoriteAddress2Id);
    }
